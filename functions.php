...
function scripts_with_jquery() {
	wp_register_script('1', get_template_directory_uri() . '/res/js/jquery-1.11.3.min.js', array('jquery'));
	wp_enqueue_script('1');
	wp_register_script('2', get_template_directory_uri() . '/res/js/bootstrap.min.js', array('jquery'));
	wp_enqueue_script('2');
	wp_register_script('3', get_template_directory_uri() . '/res/js/main.js', array('jquery'));
	wp_enqueue_script('3');
...
function my_login_logo_url() { return get_home_url(); }
add_filter('login_headerurl', 'my_login_logo_url');

function my_login_logo_url_title() { return 'Students Telkom University'; }
add_filter('login_headertitle', 'my_login_logo_url_title');

function login_error_override() { return 'Tidak bisa masuk, silakan periksa kembali data yang Anda masukkan.'; }
add_filter('login_errors', 'login_error_override');

function login_checked_remember_me() { add_filter('login_footer', 'rememberme_checked'); }
