...
<div class="container">
	<div class="col-sm-8">
		<div class="row">
			<?php if (is_active_sidebar('cat-feed-1')) { dynamic_sidebar('cat-feed-1'); }
			if (is_active_sidebar('cat-feed-2')) { dynamic_sidebar('cat-feed-2'); } ?>
		</div><hr/>
		<div class="row">
		...
		<div class="row">
			<?php if (is_active_sidebar('cat-feed-3')) { dynamic_sidebar('cat-feed-3'); }
			if (is_active_sidebar('cat-feed-4')) { dynamic_sidebar('cat-feed-4'); } ?>
		</div><hr/>
		<div class="row">
			<?php if (is_active_sidebar('cat-feed-5')) { dynamic_sidebar('cat-feed-5'); }
			if (is_active_sidebar('cat-feed-6')) { dynamic_sidebar('cat-feed-6'); }
			if (is_active_sidebar('cat-feed-7')) { dynamic_sidebar('cat-feed-7'); } ?>
		</div>
	</div>
	<?php get_sidebar(); ?>
</div>
